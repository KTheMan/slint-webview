...
- Shared rendered-frame and Slint-originated input contracts now live in
  `RenderedWebViewBackend`, `BackendRenderedWebViewController`, and related
  core types for future Servo/CEF work.
...
- Pure rendered-backend controller, frame, transport, resize validation, and
