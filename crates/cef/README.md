...
The crate currently re-exports the shared `RenderedWebViewBackend` and
`BackendRenderedWebViewController` contracts and reports planned rendered
capabilities that prefer CPU paint-buffer frames while allowing accelerated
texture paths later.
